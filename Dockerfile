...
RUN wget https://bintray.com/artifact/download/tigervnc/stable/tigervnc-Linux-i686-1.4.3.tar.gz && tar xf tigervnc-Linux-i686-1.4.3.tar.gz ~./tmp/vnc && cp -r ~./tmp/vnc/usr/* /usr/ && rm -rf ~./tmp
